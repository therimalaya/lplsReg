...
knitr::opts_chunk$set(fig.path = "figure/", echo = TRUE, message = FALSE, warning = FALSE, fig.height = 7)
```
...
[https://therimalaya.github.io/lplsreg/index.html](https://therimalaya.github.io/lplsreg/index.html)
